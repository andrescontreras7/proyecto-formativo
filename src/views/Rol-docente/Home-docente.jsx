  ...
  return (
    ...
    <Layout>
      <main className="p-4 w-full h-[84vh] 2xl:h-[84vh] max-lg:overflow-y-scroll   shadow-[0_8px_10px_15px_rgba(0,0,0,0.08)] rounded-md  lg:flex-row gap-4">
          ...
          <div className="bg-yellow-50 col-span-3 over  p-6 row-span-3 row-start-3 lg:col-start-3 lg:row-span-3  rounded-lg shadow-sm hover:shadow-lg transition-shadow duration-300">
            ...
            
            {
              porcentaje.map((item) => (
                ...
                <div className="bg-yellow-50 p-4 hover:shadow-lg transition-shadow duration-300">
            ...
            <button className="bg-teal-500   w-[90%]l text-white font-semibold p-6 rounded hover:bg-teal-600 transition-colors duration-300">Crear Nueva Clase</button>
            <button className="bg-purple-500 w-[90%] text-white font-semibold p-6 rounded hover:bg-purple-600 transition-colors duration-300">Asignar Tareas</button>
            <button className="bg-indigo-500  w-[80%] text-white font-semibold p-6 rounded hover:bg-indigo-600 transition-colors duration-300">Subir Recursos</button>
        ...
        <section className="mt-8 flex  p-2 justify-center ">
