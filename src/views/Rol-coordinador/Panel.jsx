...
<Layout titulo={"Panel de control"}  >
    ...
    <div className="col-span-2 row-span-4 overflow-auto ">
        <div className="p-2 rounded-md ">
            <h2 className="text-xl font-bold text-gray-600 bg-[#626CB8] bg-opacity-40 p-2 uppercase  rounded-lg mb-4">Opciones</h2>
            <ul className="space-y-3 rounded-lg shadow-md   bg-[#626CB8] bg-opacity-40  p-2  ">
                
                        <li className="flex items-center bg-white duration-300 cursor-pointer border  
                        border-white rounded-lg  hover:bg-[#626cb88e]  hover:border-none  ">
                            <div className='flex gap-2    items-center'>
                                <div className=' border cursor-pointer    border-[#626CB8]   p-[5px] rounded-lg  ml-[0.5%]  '>
                                    <img className=' w-11 shadow  ' src="/public/registarprofesor.png" alt="Docente" draggable="false" />
                                </div>
                                <div>
                                <h1 className='font-bold text-gray-700'> Registrar docente </h1>
                                    <p className='font-normal text-xs text-gray-800'>Lorem ipsum dolor sit amet consectetur adipisicing  </p>
                                </div>
                            </div>
                        </li>
                        ...
                        <Link to="/Listado" className="flex items-center bg-white duration-300 cursor-pointer border  
                         border-white rounded-lg  hover:bg-[#626cb88e]  hover:border-none ">
                            <div className='flex gap-2   items-center'>
                        ...
                        <Link to="/Listado" className="flex items-center bg-white duration-300 cursor-pointer border  
                         border-white rounded-lg  hover:bg-[#626cb88e]  hover:border-none ">
                           ...
                           <Link to="/Listadocentes" className="flex items-center bg-white duration-300 cursor-pointer border  
                         border-white rounded-lg  hover:bg-[#626cb88e]  hover:border-none ">
                            <div className='flex gap-2  items-center'>
                                <div className=' border cursor-pointer    border-[#626CB8]   p-[5px] rounded-lg  ml-[0.5%] py-[0.5%]  '>
                        ...
                        <Link to="/" className="flex items-center bg-white duration-300 cursor-pointer border  
                         border-white rounded-lg  hover:bg-[#626cb88e]  hover:border-none">
                            <div className='flex gap-2   items-center'>
                                <div className=' border cursor-pointer    border-[#626CB8]   p-[5px] rounded-lg  ml-[0.5%] py-[0.5%]  '>
                        ...
                        <Link to="/RegistrarAlumno" className="flex items-center bg-white duration-300 cursor-pointer border  
                         border-white rounded-lg  hover:bg-[#626cb88e]  hover:border-none">
                            <div className='flex gap-2   items-center'>
                                <div className=' border cursor-pointer    border-[#626CB8]   p-[5px] rounded-lg  ml-[0.5%] py-[0.5%]'>
                                    <img className='w-11' src="/public/estudiante 1.png" alt="Docente" draggable="false" />
                                </div>
                                <div>
                                <h1 className='font-medium text-[1.0rem] text-gray-900'> Registar alumno </h1>
                                    <p className='font-normal text-xs text-gray-800'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde q</p>
                                </div>
                            </div>
                        </Link>
                        ...
                        <Link to="/" className="flex items-center bg-white duration-300 cursor-pointer border  
                         ...
                         border-white rounded-lg  hover:bg-[#626cb88e]  hover:border-none">
                            <div className='flex gap-2   items-center'>
                                <div className=' border cursor-pointer    border-[#626CB8]   p-[5px] rounded-lg  ml-[0.5%] py-[0.5%] '>
                                    <img className='w-11' src="/public/agregar_asigantura.svg" alt="Docente" draggable="false" />
                                </div>
                                <div>
                                <h1 className='font-medium text-[1.0rem] text-gray-900'> Registrar asignatura </h1>
                                    <p className='font-normal text-xs text-gray-800'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde q</p>
                                </div>
                            </div>
                        </Link>
                        <Link to="/" className="flex items-center bg-white duration-300 cursor-pointer border  
                         border-white rounded-lg  hover:bg-[#626cb88e]  hover:border-none">
                            <div className='flex gap-2   items-center'>
                                <div className='border cursor-pointer    border-[#626CB8]   p-[5px] rounded-lg  ml-[0.5%] py-[0.5%] '>
                                    <img className='w-11' src="/public/observadores.png" alt="Docente" draggable="false" />
                                </div>
                                <div>
                                <h1 className='font-medium text-[1.0rem] text-gray-900'> Observadores </h1>
                                    <p className='font-normal text-xs text-gray-800'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde q</p>
                                </div>
                            </div>
                        </Link>
