          ...
          <article className='bg-[#86A7E7] overflow-y-scroll shadow-[0_8px_20px_20px_rgba(0,0,0,0.08)] h-[90vh] flex flex-col mt-4 rounded-xl'>
            ...
            <div className=' flex flex-wrap justify-center'>
             ...
             <button>
              ...
              <button className='w-[15vw] h-[25vh] m-4 flex flex-col bg-[#A6DCF1] items-center justify-center rounded-2xl transition-all duration-300 hover:bg-[#7365b2]'>
                <div className='bg-white flex justify-center items-center  w-[50%] h-[60%] rounded-full'>
                  <img className='w-16' src="https://s3-alpha-sig.figma.com/img/bbcb/dc94/b864343c91cd4b4ed410b64347526de1?Expires=1702857600&Signature=Mbt2m680A~2nqsWYA3yrmE9gq6YWb~CsTTcueWNG-WnJH95UcqZ4YB1NPt1J0LViUh~~ZKfYUbaagp0JGFVAqJYrt7FPb-XlqRrdlhhKRPRKDoETrQHsJj0zLwyCUeBz7TtwKOBTk~Pw3ncNathC63dud~5AOMj7Vob5y4Rdze8AvnkDmBHVNyj-ilWEcamU~75hjPLhOmxddZV007gJboog52ZmTXS6OevMU3aKm8X3tB2TqSNKqoB~m9NmrGJhw2Fpw-5AuwYi9WGGeAnlsU28qYPdkFxTVNCQdas9OxnFVpsqFXkMYLRs6TMjEUBT2VmH~H9zngW0VPIzBI319A__&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4" alt="Docente" />
                </div>
